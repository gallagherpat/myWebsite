...
const resize = function() {
    ...
    if (body.offsetWidth > 1200) for(let i = 0; i < 5; i++){
        let piece = fragment.appendChild(document.getElementById(i));
        document.getElementById("navBtn").appendChild(piece);
    }
    else if (body.offsetWidth < 1200) for(let i1 = 0; i1 < 5; i1++){
        let piece1 = fragment.appendChild(document.getElementById(i1));
        document.getElementById("mobile").appendChild(piece1);
    }
};
...
},{}]},["2mNKm","6rimH"], "6rimH", "parcelRequire9013")
